		...
		<div class="container">
				...
				<section class="classy-slider">
					<!-- <div class="slide slide--current" data-content="content-1">
						<div class="slide__mover">
							<div class="zoomer flex-center">
								<img class="zoomer__image" src="<?php echo get_template_directory_uri(); ?>/assets/images/iphone.png" alt="iPhone" />
								<div class="preview">
									<img src="<?php echo get_template_directory_uri(); ?>/assets/images/iphone-content-preview.png" alt="iPhone app preview" />
					...
					<div class="slide" data-content="content-2">
						<div class="slide__mover">
							<div class="zoomer flex-center">
								<img class="zoomer__image" src="<?php echo get_template_directory_uri(); ?>/assets/images/ipad.png" alt="iPad Mini" />
								<div class="preview">
									<img src="<?php echo get_template_directory_uri(); ?>/assets/images/ipad-content-preview.png" alt="iPad Mini app preview" />
					...
					<div class="slide slide--current" data-content="content-1">
						<div class="slide__mover">
							<div class="zoomer flex-center">
								<img class="zoomer__image slider-img" src="<?php echo get_template_directory_uri(); ?>/assets/images/imac.png" alt="iMac" />
								<div class="preview">
									<img class="slider-img" src="<?php echo get_template_directory_uri(); ?>/assets/images/imac-content-preview-bootstrap.jpg" alt="iMac app preview" />
					...
					<div class="slide" data-content="content-2">
						<div class="slide__mover">
							<div class="zoomer flex-center">
								<img class="zoomer__image slider-img" src="<?php echo get_template_directory_uri(); ?>/assets/images/macbook.png" alt="Macbook" />
								<div class="preview">
									<img class="slider-img" src="<?php echo get_template_directory_uri(); ?>/assets/images/macbook-content-preview-rmbl.jpg" alt="macbook app preview" />
									<div class="zoomer__area zoomer__area--size-4"></div>
								</div>
							</div>
						</div>
					...
					<div class="slide" data-content="content-3">
						<div class="slide__mover">
							<div class="zoomer flex-center">
								<img class="zoomer__image slider-img" src="<?php echo get_template_directory_uri(); ?>/assets/images/imac.png" alt="iMac" />
								<div class="preview">
									<img class="slider-img" src="<?php echo get_template_directory_uri(); ?>/assets/images/imac-content-preview-jags.jpg" alt="iMac app preview" />
									<div class="zoomer__area zoomer__area--size-5"></div>
								</div>
							</div>
						</div>
					...
					<div class="slide" data-content="content-4">
						<div class="slide__mover">
							<div class="zoomer flex-center">
								<img class="zoomer__image" src="<?php echo get_template_directory_uri(); ?>/assets/images/ipad.png" alt="iPad Mini" />
								<div class="preview">
									<img src="<?php echo get_template_directory_uri(); ?>/assets/images/ipad-content-preview-jags2.jpg" alt="iPad Mini app preview" />
									<div class="zoomer__area zoomer__area--size-4"></div>
								</div>
							</div>
						</div>
				...
				<section class="content">
					<!-- <div class="content__item" id="content-1">
						<img class="content__item-img rounded-right" src="<?php echo get_template_directory_uri(); ?>/assets/images/iphone-content.png" alt="Apple Watch Content" />
					...
					<div class="content__item" id="content-2">
						<img class="content__item-img rounded-right" src="<?php echo get_template_directory_uri(); ?>/assets/images/ipad-content.jpg" alt="iPad Mini Content" />
						<div class="content__item-inner">
							<h2>The iPad Mini</h2>
					...
					<div class="content__item" id="content-3">
						<img class="content__item-img rounded-right" src="<?php echo get_template_directory_uri(); ?>/assets/images/macbook-content-jags.jpg" alt="MacBook Content" />
						<div class="content__item-inner">
							<h2>The MacBook</h2>
					...
					<div class="content__item" id="content-2">
						<img class="content__item-img rounded-right" src="<?php echo get_template_directory_uri(); ?>/assets/images/macbook-content-rmbl.jpg" alt="iMac Content" />
						<div class="content__item-inner">
							<h2>The iMac</h2>
					...
					<div class="content__item" id="content-1">
						<img class="content__item-img rounded-right" src="<?php echo get_template_directory_uri(); ?>/assets/images/imac-content-bootstrap.jpg" alt="Apple Watch Content" />
						<div class="content__item-inner">
					...
					<div class="content__item" id="content-4">
						<img class="content__item-img rounded-right" src="<?php echo get_template_directory_uri(); ?>/assets/images/ipad-content-jags2.jpg" alt="Apple Watch Content" />
						<div class="content__item-inner">
							<h2>The Apple Watch</h2>
							<h3>Entirely new ways to stay in touch</h3>
							<p>Apple Watch makes all the ways you're used to communicating more convenient. And because it sits right on your wrist, it can add a physical dimension to alerts and notifications. For example, you’ll feel a gentle tap with each incoming message. Apple Watch also lets you connect with your favorite people in fun, spontaneous ways — like sending a tap, a sketch, or even your heartbeat. </p>
