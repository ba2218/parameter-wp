		...
		<div class="container" id="sliderContainer">
			...
			<section class="content">
					...
					<div class="content__item" id="content-2">
						<img class="content__item-img rounded-right" src="<?php echo get_template_directory_uri(); ?>/assets/images/slider/ipad-content.jpg" alt="iPad Mini Content" />
						<div class="content__item-inner">
							<h2>The iPad Mini</h2>
					...
					<div class="content__item" id="content-3">
						...
						<div class="content__item-inner">
							...
							<p><a href="http://arcade.jaguars.com/DuvalDash/">Learn More &xrarr;</a></p>
						</div>
					</div>
					<div class="content__item" id="content-2">
					...
					<div class="content__item" id="content-4">
						...
						<div class="content__item-inner">
							...
							<p><a href="http://arcade.jaguars.com/RiverCityRollers/">Learn More &xrarr;</a></p>
						</div>
					</div>
